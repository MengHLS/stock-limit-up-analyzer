...
export const RESEARCH_REFERENCE_ERROR = {
  ...
  /** RESEARCH-FINDING-001：发现不存在。 */
  FINDING_NOT_FOUND: "RESEARCH_FINDING_NOT_FOUND",
  /** RESEARCH-PLANNER-001：研究问题不存在。 */
  QUESTION_NOT_FOUND: "RESEARCH_QUESTION_NOT_FOUND",
  /** RESEARCH-PLANNER-001：研究计划不存在。 */
