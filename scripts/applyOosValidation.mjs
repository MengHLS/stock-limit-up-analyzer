// OOS-001 — Out-of-Sample Validation migration 应用脚本。
//
// 与 applyParameterSearch.mjs / applySearchRobustness.mjs 同一引擎、同一纪律：
//   按 SQL 内的 `-- @guard: <kind> <target>` 指令**先查 information_schema 再执行**，
//   重复运行完全无副作用。
//
// 用法：
//   node scripts/applyOosValidation.mjs              # 应用（幂等）+ 前后对比断言
//   node scripts/applyOosValidation.mjs --dry-run    # 只报告将执行/将跳过的语句 + 当前断言
//   node scripts/applyOosValidation.mjs --check      # 只读断言，不执行任何 DDL
//
...
const SQL_FILE = "../drizzle/0043_oos_validation.sql";

/** boolean → tinyint(1)（实测：drizzle `boolean()` 在 TiDB 落成 `tinyint(1)`）。 */
const BOOL = { base: "tinyint", len: 1 };

// ---------------------------------------------------------------------------
// 期望结构（唯一权威 = drizzle/schema.ts#oosValidation*；此处冻结一份用于真库比对）
// ---------------------------------------------------------------------------
...
const EXPECTED = {
  oos_validation_run: {
    columns: [
      ...
      { column: "oosRunId", base: "varchar", len: 80, nullable: "NO", key: "UNI" },
      { column: "sourceSearchRunId", base: "varchar", len: 80, nullable: "NO", key: "MUL" },
      { column: "sourceParameterHash", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "sourceCombinationIndex", base: "int", nullable: "YES", ...NONE },
      { column: "strategyId", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "strategyVersion", base: "varchar", len: 32, nullable: "NO", ...NONE },
      { column: "strategyVersionId", base: "varchar", len: 96, nullable: "NO", ...NONE },
      { column: "strategyDefinitionFingerprint", base: "varchar", len: 64, nullable: "YES", ...NONE },
      { column: "datasetVersionId", base: "bigint", nullable: "YES", ...NONE },
      { column: "datasetVersionLabel", base: "varchar", len: 96, nullable: "YES", ...NONE },
      { column: "searchStartDate", base: "date", nullable: "NO", ...NONE },
      { column: "searchEndDate", base: "date", nullable: "NO", ...NONE },
      { column: "oosStartDate", base: "date", nullable: "NO", ...NONE },
      { column: "oosEndDate", base: "date", nullable: "NO", ...NONE },
      { column: "searchSnapshotJson", base: "longtext", nullable: "NO", ...NONE },
      { column: "searchSnapshotFingerprint", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "fixedCoordinatesJson", base: "text", nullable: "NO", ...NONE },
      { column: "executionPolicyVersion", base: "int", nullable: "NO", ...NONE },
      { column: "evaluationConfigFingerprint", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "resolvedParameterSetJson", base: "longtext", nullable: "NO", ...NONE },
      ...
      { column: "notesJson", base: "longtext", nullable: "YES", ...NONE },
    ...
    indexes: [
      { name: "uq_oos_validation_run_id", unique: true, columns: "oosRunId" },
      { name: "idx_oos_validation_run_source", unique: false, columns: "sourceSearchRunId" },
      { name: "idx_oos_validation_run_created", unique: false, columns: "createdAt" },
      { name: "idx_oos_validation_run_status", unique: false, columns: "status" },
    ],
  },
  oos_validation_result: {
    columns: [
      { column: "id", base: "bigint", nullable: "NO", key: "PRI" },
      // ⚠️ 复合 UNIQUE `(oosRunId, sourceParameterHash)` 的**首列**在 information_schema 里
      // 报 `MUL` 而非 `UNI`（0041/0042 实测同款）。
      { column: "oosRunId", base: "varchar", len: 80, nullable: "NO", key: "MUL" },
      { column: "sourceSearchRunId", base: "varchar", len: 80, nullable: "NO", ...NONE },
      { column: "sourceParameterHash", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "sourceCombinationIndex", base: "int", nullable: "YES", ...NONE },
      { column: "strategyVersionId", base: "varchar", len: 96, nullable: "NO", ...NONE },
      { column: "datasetVersionId", base: "bigint", nullable: "YES", ...NONE },
      ...
      { column: "oosStartDate", base: "date", nullable: "NO", ...NONE },
      { column: "oosEndDate", base: "date", nullable: "NO", ...NONE },
      { column: "isTotalReturnPct", base: "double", nullable: "YES", ...NONE },
      { column: "isAnnualizedReturnPct", base: "double", nullable: "YES", ...NONE },
      { column: "isMaxDrawdownPct", base: "double", nullable: "YES", ...NONE },
      { column: "isTradeCount", base: "int", nullable: "YES", ...NONE },
      { column: "isWinRatePct", base: "double", nullable: "YES", ...NONE },
      { column: "isProfitFactor", base: "double", nullable: "YES", ...NONE },
      { column: "isMetricsSource", base: "varchar", len: 16, nullable: "NO", ...NONE },
      { column: "isAnnualizationBasisJson", base: "text", nullable: "YES", ...NONE },
      { column: "oosTotalReturnPct", base: "double", nullable: "YES", ...NONE },
      { column: "oosAnnualizedReturnPct", base: "double", nullable: "YES", ...NONE },
      { column: "oosMaxDrawdownPct", base: "double", nullable: "YES", ...NONE },
      { column: "oosTradeCount", base: "int", nullable: "YES", ...NONE },
      { column: "oosWinRatePct", base: "double", nullable: "YES", ...NONE },
      { column: "oosProfitFactor", base: "double", nullable: "YES", ...NONE },
      { column: "oosMetricsSource", base: "varchar", len: 16, nullable: "NO", ...NONE },
      { column: "oosAnnualizationBasisJson", base: "text", nullable: "YES", ...NONE },
      { column: "comparisonJson", base: "longtext", nullable: "NO", ...NONE },
      { column: "status", base: "varchar", len: 16, nullable: "NO", ...NONE },
      { column: "error", base: "text", nullable: "YES", ...NONE },
      { column: "backtestFingerprint", base: "varchar", len: 64, nullable: "YES", ...NONE },
      { column: "evaluationId", base: "varchar", len: 80, nullable: "YES", ...NONE },
      { column: "evaluationRunId", base: "varchar", len: 160, nullable: "YES", ...NONE },
      { column: "executionPolicyVersion", base: "int", nullable: "NO", ...NONE },
      { column: "metricsVersion", base: "varchar", len: 48, nullable: "NO", ...NONE },
      { column: "engineVersion", base: "varchar", len: 48, nullable: "NO", ...NONE },
      { column: "fingerprint", base: "varchar", len: 64, nullable: "NO", ...NONE },
      { column: "notesJson", base: "longtext", nullable: "NO", ...NONE },
      { column: "createdAt", base: "timestamp", nullable: "NO", ...NONE },
      { column: "updatedAt", base: "timestamp", nullable: "NO", ...NONE },
    ],
    indexes: [
      { name: "uq_oos_validation_result_candidate", unique: true, columns: "oosRunId,sourceParameterHash" },
      { name: "idx_oos_validation_result_run", unique: false, columns: "oosRunId,sourceCombinationIndex" },
      { name: "idx_oos_validation_result_status", unique: false, columns: "oosRunId,status" },
    ],
  },
};
...
const OBSERVED_TABLES = ["parameter_search_run", "closed_loop_backtest_run"];
