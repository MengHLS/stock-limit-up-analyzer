...
import { visibleBars, type CanonicalMarketBar } from "../../server/data";
import { resolveLimitRules } from "../../server/data/boardRules";
import { LeakageGuard, LookAheadError, type DecisionTime } from "../../server/research/framework/leakage";
import { sameDayAvailability } from "../../server/research/framework/featureProvider";
import { isKnowableBy, statusKnowledgeDate } from "../../server/securityStatus/pointInTime";
import type { SecurityStatusInterval } from "../../server/securityStatus/types";
import { buildTradingCalendar } from "../../server/security/tradingCalendar";
import { getIndustryAt } from "../../server/marketData/industry";
import type { IndustryAssignment } from "../../server/marketData/types";
import { buildFactorSeriesFromActions } from "../../server/corporateActions/engine";
import { filterActionsKnownAt, isCorporateActionKnownAt } from "../../server/corporateActions/integration";
