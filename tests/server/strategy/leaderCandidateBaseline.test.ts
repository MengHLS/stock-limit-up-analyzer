...
import { DEFAULT_COST_MODEL, runBacktest, runBacktestWithRisk, type MarketBar } from "../../../server/engine";
import { buildLeaderCandidatesForDate, type LeaderCandidateSourceRecord } from "../../../server/leaderCandidates";
import { buildLeaderCandidateDataViewForDate, buildStrategySignalProvider, toCoreSignals } from "../../../server/strategy/adapter";
import { strategyRegistry } from "../../../server/strategy/registry";
import { registerBuiltInStrategies } from "../../../server/strategy/strategies";
import { leaderCandidateBaselineStrategy, type LeaderCandidateBaselineConfig } from "../../../server/strategy/strategies/leaderCandidateBaseline";
