...
import { runBacktestWithRisk } from "../../../server/engine/engine";
import { toCanonicalBar, toEngineMarketBar, validateMarketBar, type CanonicalMarketBar } from "../../../server/data";
import { FeatureRegistry, registerBasicFeatures, runFeaturePipeline, type FeatureSnapshot } from "../../../server/features";
import { toCoreSignals, buildLeaderCandidateDataViewForDate } from "../../../server/strategy/adapter";
import type { LeaderCandidateSourceRecord } from "../../../server/leaderCandidates";
import { StrategyRegistry } from "../../../server/strategy/registry";
import type { AnyStrategy, ReadonlyPortfolioContext, StrategyContext } from "../../../server/strategy/contract";
import { leaderCandidateBaselineStrategy } from "../../../server/strategy/strategies/leaderCandidateBaseline";
import { DEFAULT_COST_MODEL } from "../../../server/engine/execution";
import type { BacktestConfig, MarketBar } from "../../../server/engine/domain";
