...
import { registerBuiltInResearchStrategies } from "../../../server/research/adapter";
import { ExperimentRegistry } from "../../../server/research/experimentRegistry";
import { ExperimentService } from "../../../server/research/experimentService";
import { runResearchBacktest, type ResearchDataLoader } from "../../../server/research/engineAdapter";
import {
  InMemoryExperimentRepository,
  InMemoryResearchRunRepository,
  InMemorySweepBatchRepository,
} from "../../../server/research/persistence/inMemory";
import type { ExperimentRepository, SweepBatchRepository } from "../../../server/research/persistence/contract";
import { ResearchStrategyRegistry } from "../../../server/research/registry";
import { createDefaultExecutor, ResearchRunService, type ResearchBacktestExecutor } from "../../../server/research/runService";
import { sortSweepResults, type ExperimentBatch } from "../../../server/research/sweep";
import { SweepService, type CreateSweepInput } from "../../../server/research/sweepService";
import type { RawDailyPriceRow } from "../../../server/data";
import type { LeaderCandidateSourceRecord } from "../../../server/leaderCandidates";
import type { ParameterSpace } from "../../../server/research/parameterSpace";
import type { SweepResult } from "../../../server/research/sweep";
import type { ResearchExperiment } from "../../../server/research/types";
