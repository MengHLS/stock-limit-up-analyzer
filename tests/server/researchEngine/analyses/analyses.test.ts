...
import type { ResearchAnalysis, ResearchConditionSet } from "../../../../server/researchCore";
...
import { buildSyntheticDataset, linearEvents, type SyntheticEventSpec } from "../../../../server/researchEngine/testFixtures";
import type { AnalysisExecutionContext, ResolvedEngineAnalysisConfig } from "../../../../server/researchEngine/types";
