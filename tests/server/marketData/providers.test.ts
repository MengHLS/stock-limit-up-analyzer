...
import { parseTushareIndexDaily, parseTushareDailyBasic, type TusharePayload } from "../../../server/marketData/providers/tushare";
import { parseSinaIndexDaily, parseSinaIndexQuote, toSinaSymbol } from "../../../server/marketData/providers/sina";
import { parseBaostockIndexDaily, parseBaostockStockDaily, toBaostockCode } from "../../../server/marketData/providers/baostock";
import { parseAkShareSwIndustries, parseAkShareSwMembers } from "../../../server/marketData/providers/akshare";
