...
import { buildLeaderCandidateBaselineResearchDefinition, registerBuiltInResearchStrategies } from "../../../server/research/adapter";
import { ResearchEvaluationService } from "../../../server/research/evaluationService";
import type { ResearchBacktestExecutor } from "../../../server/research/runService";
import { ResearchStrategyRegistry } from "../../../server/research/registry";
import { createResearchEvaluationPlan, type ResearchEvaluationPlan } from "../../../server/research/trainValidationOos";
import type { ResearchDatasetSplit } from "../../../server/research/datasetSplit";
import type { ResearchExperimentSnapshot } from "../../../server/research/types";
import type { BacktestResult, CostModel, PerformanceMetrics } from "../../../server/engine/domain";
import { makePerformanceMetrics } from "../../../server/research/evaluationService";
