...
import { buildSyntheticDataset, linearEvents } from "../../server/researchEngine/testFixtures";
...
describe("researchEngineRouter — 注册与权限", () => {
  it("appRouter 暴露全部 researchEngine 端点", () => {
    ...
    const expected = [
      ...
      "researchEngine.listFindings",
      "researchEngine.getFinding",
      "researchEngine.detectFindings",
      "researchEngine.reviewFinding",
      "researchEngine.getHypothesis",
      "researchEngine.testHypothesis",
      "researchEngine.createCandidateFromHypothesis",
