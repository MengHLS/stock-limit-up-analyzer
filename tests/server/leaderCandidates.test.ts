...
import { buildLeaderCandidateBacktest, buildLeaderCandidateDailyPriceMap, buildLeaderCandidates } from "../../server/leaderCandidates";
...
describe("buildLeaderCandidates", () => {
  it("价格映射保留仅有开盘或仅有收盘的日线，丢弃两项都无效的记录", () => {
    ...
    expect(map.get("600001.SH::2026-08-20")).toEqual({ openPrice: 11, closePrice: null, highPrice: null, lowPrice: null, amount: null, volume: null, preClosePrice: null });
    expect(map.get("600002.SH::2026-08-20")).toEqual({ openPrice: null, closePrice: 12, highPrice: null, lowPrice: null, amount: null, volume: null, preClosePrice: null });
