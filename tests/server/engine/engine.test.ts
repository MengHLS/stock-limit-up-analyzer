...
import {
  ...
  type MarketBar,
  type Signal,
} from "../../../server/engine/execution";
import { Portfolio } from "../../../server/engine/portfolio";
import { completedTrades, computePerformance, dailyReturnsFromEquity, maxDrawdownFromEquity } from "../../../server/engine/performance";
import { runBacktest } from "../../../server/engine/engine";
import type { BacktestConfig, Fill } from "../../../server/engine/domain";
