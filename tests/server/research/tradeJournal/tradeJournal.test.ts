...
import { createExecutionConstraintDeclaration } from "../../../../server/research/executionConstraints/factory";
import { computeCandidateEvaluationRunFingerprint } from "../../../../server/research/signalEngine";
import { createPaperAccount } from "../../../../server/research/paperAccount/account";
import { PAPER_ACCOUNT_ERROR_CODES } from "../../../../server/research/paperAccount/errors";
import type { PaperAccount } from "../../../../server/research/paperAccount/types";
import type {
  CandidateDayRecord,
  CandidateEvaluationRun,
  CandidateRunEvaluation,
  SecuritySelectionStat,
} from "../../../../server/research/signalEngine/types";
import type { DirectionCounts, PositionIntent } from "../../../../server/research/framework/contract";
import type { DecisionPoint } from "../../../../server/data";
import type { CostModelDeclaration } from "../../../../server/research/costModel/types";
import type { ExecutionConstraintDeclaration } from "../../../../server/research/executionConstraints/types";
import type { ResearchParameterSet } from "../../../../server/research/types";
import { runSignalToPnlLoop } from "../../../../server/research/signalToPnl/engine";
import type {
  PnlLoopPriceSnapshot,
  PnlLoopPriceSource,
  SignalToPnlLoopInput,
  SignalToPnlRun,
} from "../../../../server/research/signalToPnl/types";
import {
  ...
  TJ_ERROR_CODES,
  TradeJournalError,
} from "../../../../server/research/tradeJournal";
